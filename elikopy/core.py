...
class Elikopy:
    ...
    def fingerprinting(self, dictionary_path=None, folder_path=None, peaksType="MSMT-CSD", maskType="brain_mask_dilated", csf_mask=True, ear_mask=False,force_axial: bool=False, mfdir=None, output_filename:str="",
