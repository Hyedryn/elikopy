...
def preproc_solo(folder_path, p, reslice=False, denoising=False,gibbs=False, topup=False,  eddy=False, starting_state=None, bet_median_radius=2, bet_numpass=1, bet_dilate=2, cuda=False, cuda_name='eddy_cuda10.1', s2v=[6,5,1,'trilinear'], olrep=[False, 4, 250, 'sw']):
    """
